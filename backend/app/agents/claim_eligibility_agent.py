...
Provide a clear, very concise verdict ("Eligible", "Not Eligible", or "Needs More Information") followed by a one-sentence direct explanation. Do not include detailed reasoning paragraphs."""
